...
function f3() {
  document.getElementsByClassName('dropdown-3')[0].classList.toggle('down');
  document.getElementsByClassName('arrow-3')[0].classList.toggle('gone');
...
function f4() {
  document.getElementsByClassName('dropdown-4')[0].classList.toggle('down');
  document.getElementsByClassName('arrow-4')[0].classList.toggle('gone');
...
function f5() {
  document.getElementsByClassName('dropdown-5')[0].classList.toggle('down');
  document.getElementsByClassName('arrow-5')[0].classList.toggle('gone');
...
function f6() {
  document.getElementsByClassName('dropdown-6')[0].classList.toggle('down');
  document.getElementsByClassName('arrow-6')[0].classList.toggle('gone');
